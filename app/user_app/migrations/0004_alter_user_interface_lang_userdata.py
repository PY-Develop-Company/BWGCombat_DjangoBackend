    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rank_id', models.OneToOneField(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='levels_app.rank')),
                ('stage_id', models.OneToOneField(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='levels_app.stage')),
            ],
        ),
    ]
