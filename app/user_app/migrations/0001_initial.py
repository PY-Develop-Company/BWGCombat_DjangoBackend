    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('click_multiplier_level', models.ForeignKey(blank=True, default=1, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Click_level', to='levels_app.multiplierlevel')),
                ('energy_level', models.ForeignKey(blank=True, default=1, null=True, on_delete=django.db.models.deletion.SET_NULL, to='levels_app.energylevel')),
