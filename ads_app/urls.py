...
urlpatterns = [
    ...
    path("get_relevant_random_fullscreen_advert/", views.get_relevant_random_fullscreen_advert, name="get_relevant_random_fullscreen_advert"),
    path("all_banner_adverts/", views.get_all_banner_adverts, name="get_all_banner_adverts"),
    path("all_active_banner_adverts/", views.get_all_active_banner_adverts, name="get_all_active_banner_adverts"),
    path("all_fullscreen_adverts/", views.get_all_fullscreen_adverts, name="get_all_fullscreen_adverts"),
    path("all_active_fullscreen_adverts/", views.get_all_active_fullscreen_adverts, name="get_all_active_fullscreen_adverts"),
